...
const titleStyle =
  "md:my-[8px] mt-[12px] text-[42px] md:text-[56px] font-[600] text-[#2f2f30] tracking-widest";
...
const lineStyle = "h-full w-[1px] bg-[#2f2f30]";

const titleRowStyle = "flex items-center";

const headerStyle =
  "w-full flex flex-col justify-between items-center py-[8px]";
